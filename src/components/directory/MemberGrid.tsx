...
export const MemberGrid: React.FC<MemberGridProps> = ({ members, loading = false }) => {
  if (loading) {
    return (
      <div className="grid grid-cols-1 xs:grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
